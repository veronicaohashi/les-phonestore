...
public class CapacityViewHelper implements IViewHelper{
	...
	public void setView(Result result, HttpServletRequest request, 
		...
		if (result.getMsg() == null) {
			if (action.equals("LIST")) {		
				List<DomainEntity> capacities = result.getEntities();  							
				
				String json = new Gson().toJson(capacities);
	...
	public void setView(Result result, ServletConfig config) {
		config.getServletContext().setAttribute("capacityResult", result);		
	}
